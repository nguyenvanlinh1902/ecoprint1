...
// Tạo một biến singleton để lưu thể hiện của app
let appInstance = null;

const getApp = () => {
  if (appInstance) {
    console.log('[API Handler] Sử dụng app instance hiện có');
    return appInstance;
  }
  
  console.log('[API Handler] Khởi tạo app instance mới');
...
// Xuất ra một handler đã được tạo sẵn
